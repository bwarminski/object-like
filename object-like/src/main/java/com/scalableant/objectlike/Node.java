...
public abstract class Node implements Iterable<Node>
{
    ...
    public final boolean isContainerNode() {
        final NodeType type = getNodeType();
        return type == NodeType.OBJECT || type == NodeType.ARRAY;
    }

    public final boolean isMissingNode() {
        return getNodeType() == NodeType.MISSING;
    }
     ...
     */
    public Node get(String fieldName) { return null; }
    /**
     ...
     * @param fieldName Name of field to look for
     */
    public final List<Node> findValues(String fieldName)
    {
        List<Node> result = findValues(fieldName, null);
        if (result == null) {
     ...
     */
    public final Node findPath(String fieldName)
    {
        Node value = findValue(fieldName);
        if (value == null) {
     ...
     */
    public Node with(String propertyName) {
     ...
     * {@link UnsupportedOperationException} is thrown
     */
    public Node withArray(String propertyName) {
        throw new UnsupportedOperationException("JsonNode not of type ObjectNode (but "
